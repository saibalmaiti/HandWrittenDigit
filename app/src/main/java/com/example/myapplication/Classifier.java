...
public class Classifier {
    private static final String MODEL_NAME = "converted_model_digit.tflite";
    ...
    private  Interpreter.Options options = new Interpreter.Options().setNumThreads(5).setUseNNAPI(true);
